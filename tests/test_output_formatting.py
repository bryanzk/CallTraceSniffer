...
class TestOutputFormatting:
    ...
    def test_complete_format(self):
        ...
        output = converter.converter.generate_test_case_format(tx_hash, swaps, execution_tree, transfers)
    ...
    def test_swaps_section_format(self):
        ...
        transfers = []
        output = converter.converter.generate_test_case_format("0x123", swaps, execution_tree, transfers)
