...
converter = TransactionConverter() extract_transfers_from_data, is_router_address, ROUTER_ADDRESSES
...
class TestTransferExtraction:
    ...
    def test_transfer_by_selector(self, sample_data_map):
        ...
        transfers = converter.converter.extract_transfers_from_data(sample_data_map)
        # 应该找到多个transfer
    ...
    def test_transfer_type_router(self):
        ...
        transfers2 = converter.converter.extract_transfers_from_data(data_map2)
    ...
    def test_transfer_type_virtual(self):
        ...
        transfers1 = converter.converter.extract_transfers_from_data(data_map1)
    ...
    def test_empty_data_map(self, empty_data_map):
        """测试空dataMap"""
        transfers = converter.converter.extract_transfers_from_data(empty_data_map)
        assert transfers == []
